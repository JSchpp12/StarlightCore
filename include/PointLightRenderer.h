...
//namespace star {
//    namespace core {
//        class PointLightRenderer : public common::Renderer {
//        public:
//            std::unique_ptr<const char**> glfwRequiredExtensions;
//            std::unique_ptr<uint32_t> glfwRequiredExtensionsCount;
//
//            PointLightRenderer(common::ConfigFile* configFile, common::FileResourceManager<common::Shader>* shaderManager, common::FileResourceManager<common::GameObject>* objectManager, common::FileResourceManager<common::Texture>* textureManager, common::Camera* inCamera, std::vector<common::Handle>* objectHandleList);
//
//            ~PointLightRenderer();
//
